...
# Print column names
cat ("#nb.repetition, mean.R2.env, sd.R2.env, ci.lower.env, ci.upper.env, mean.R2.spat, sd.R2.spat, ci.lower.spat, ci.upper.spat, mean.R2.shared, sd.R2.shared, ci.lower.shared, ci.upper.shared, mean.R2.resid, sd.R2.resid, ci.lower.resid, ci.upper.resid \n")
